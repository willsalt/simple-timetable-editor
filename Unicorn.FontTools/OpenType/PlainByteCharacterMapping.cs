...
namespace Unicorn.FontTools.OpenType
{
    ...
    public class PlainByteCharacterMapping : CharacterMapping
    {
        ...
        public PlainByteCharacterMapping(PlatformId platform, ushort encoding, ushort language, IEnumerable<ushort> data) : base(platform, encoding, language)
        {
            ...
            if (_data.Length < 256)
            {
                throw new ArgumentException(Resources.OpenType_PlainByteCharacterMapping_FromBytes_ArrayTooSmall, nameof(data));
            }
            if (_data.Length > 256)
            {
                throw new ArgumentException(Resources.OpenType_PlainByteCharacterMapping_FromBytes_ArrayTooLarge, nameof(data));
            }
        }
