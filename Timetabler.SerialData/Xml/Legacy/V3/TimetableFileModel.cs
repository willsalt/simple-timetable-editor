...
namespace Timetabler.SerialData.Xml.Legacy.V3
{
    /// <summary>
    /// The top-level type for XML-serializing a document to and from storage.
    /// </summary>
    [XmlRoot(ElementName = "DocumentModel", Namespace = Namespaces.V3)]
    public class TimetableFileModel
    {
        ...
        /// <summary>
        /// The list of network maps used by these timetables.
        /// </summary>
        [XmlArray]
        [XmlArrayItem(ElementName = "Map")]
        public List<NetworkMapModel> Maps { get; }
