...
namespace Timetabler.SerialData.Xml.Legacy.V1
{
    /// <summary>
    /// The top-level type for XML-serializing a document to and from storage.
    /// </summary>
    [XmlRoot(ElementName = "DocumentModel", Namespace = Namespaces.V1)]
    public class TimetableFileModel
    {
        ...
        /// </summary>
        [XmlArray]
        [XmlArrayItem(ElementName = "Train", Namespace = Namespaces.V1)]
