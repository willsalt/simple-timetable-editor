...
#pragma warning disable CA1707 // Identifiers should not contain underscores
        ...
        public void TableRowClass_IndexerSetMethod_InvalidatesEnumerator()
        {
        ...
        [TestMethod]
        public void TableRowClass_AddMethod_IncreasesCountPropertyByOne()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList();
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_AddMethod_SetsItemWithIndexEqualToCountMinus1()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList();
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_AddRangeMethod_IncreasesCountPropertyByAmountEqualToCountPropertyOfParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList();
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_AddRangeMethod_SetsNewElementsInCollectionToCorrectValues()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList();
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidOperationException))]
        public void TableRowClass_AddRangeMethod_InvalidatesEnumerator()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_ClearMethod_SetsCountPropertyToZero()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList();
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidOperationException))]
        public void TableRowClass_ClearMethod_InvalidatesEnumerator()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_GetEnumeratorMethod_ReturnsNewObjectOnEachCall()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList();
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_InsertMethod_IncreasesCountPropertyBy1_IfFirstParameterIsWithinRange()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_InsertMethod_SetsElementAtFirstParameterToSecondParameter_IfFirstParameterIsWithinRange()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidOperationException))]
        public void TableRowClass_InsertMethod_InvalidatesEnumerator_IfFirstParameterIsWithinRange()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        public void TableRowClass_InsertMethod_ThrowsIndexOutOfRangeException_IfFirstParameterIsLessThanZero()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveMethod_ReturnsFalse_IfCollectionDidNotContainParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveMethod_DoesNotChangeCountProperty_IfCollectionDidNotContainParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveMethod_DoesNotInvalidateEnumerator_IfCollectionDidNotContainParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveMethod_ReturnsTrue_IfCollectionContainedParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveMethod_ReducesCountPropertyBy1_IfCollectionContainedParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveMethod_RemovesParameterFromCollection_IfCollectionContainedParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveMethod_ReducesIndexOfElementsInCollectionAfterParameterBy1_IfCollectionContainedParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidOperationException))]
        public void TableRowClass_RemoveMethod_InvalidatesEnumerator_IfCollectionContainedParameter()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void TableRowClass_RemoveAtMethod_ThrowsIndexOutOfRangeException_IfParameterIsLessThanZero()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void TableRowClass_RemoveAtMethod_ThrowsIndexOutOfRangeException_IfParameterEqualsCountProperty()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void TableRowClass_RemoveAtMethod_ThrowsIndexOutOfRangeException_IfParameterIsGreaterThanCountProperty()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveAtMethod_ReducesCountPropertyBy1_IfParameterIsInRange()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveAtMethod_RemovesElementAtIndexEqualToParameter_IfParameterIsInRange()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        public void TableRowClass_RemoveAtMethod_ReducedIndexesOfElementsWithIndexesGreaterThanParameterBy1_IfParameterIsInRange()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
        ...
        [TestMethod]
        [ExpectedException(typeof(InvalidOperationException))]
        public void TableRowClass_RemoveAtMethod_InvalidatesEnumerator_IfParameterIsInRange()
        {
            List<TableCell> testContents = FixedSizeTableCell.GetCellList(_rnd.Next(1, 32));
            TableRow testObject = new TableRow();
            testObject.AddRange(testContents);
